// Dummy assessment template data
export const dummyAssessmentTemplate = {
  id: 'tpl_01HZXXS3N9',
...
// Dummy previous assessments data
export const dummyPreviousAssessments = [
  {
    id: 'ai_1234567890_abc123',
    submittedAt: '2024-12-15T10:30:00Z',
    scoreCard: {
      overallScore: 72,
      bucketLabel: 'Established'
    },
    responses: [
      { questionId: 'q_data_architecture', answer: { value: 'ESTABLISHED' } },
      { questionId: 'q_data_governance', answer: { value: 'EMERGING' } },
      { questionId: 'q_smart_lab', answer: { value: 'ESTABLISHED' } },
      { questionId: 'q_analytics_ai', answer: { value: 'EMERGING' } },
      { questionId: 'q_manufacturing', answer: { value: 'ESTABLISHED' } },
      { questionId: 'q_leadership', answer: { value: 'ESTABLISHED' } },
      { questionId: 'q_skills', answer: { value: 'EMERGING' } },
      { questionId: 'q_customer_feedback', answer: { value: 'ESTABLISHED' } },
      { questionId: 'q_sustainability', answer: { value: 'EMERGING' } },
      { questionId: 'q_supplier', answer: { value: 'EMERGING' } }
    ]
  },
  {
    id: 'ai_0987654321_def456',
    submittedAt: '2024-11-20T14:15:00Z',
    scoreCard: {
      overallScore: 58,
      bucketLabel: 'Emerging'
    },
    responses: [
      { questionId: 'q_data_architecture', answer: { value: 'EMERGING' } },
      { questionId: 'q_data_governance', answer: { value: 'BASIC' } },
      { questionId: 'q_smart_lab', answer: { value: 'EMERGING' } },
      { questionId: 'q_analytics_ai', answer: { value: 'BASIC' } },
      { questionId: 'q_manufacturing', answer: { value: 'EMERGING' } },
      { questionId: 'q_leadership', answer: { value: 'EMERGING' } },
      { questionId: 'q_skills', answer: { value: 'BASIC' } },
      { questionId: 'q_customer_feedback', answer: { value: 'EMERGING' } },
      { questionId: 'q_sustainability', answer: { value: 'BASIC' } },
      { questionId: 'q_supplier', answer: { value: 'EMERGING' } }
    ]
  }
];