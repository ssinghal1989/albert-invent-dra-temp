...
export const TIER1_DEFAULT_QUESTIONS = [
  {
    templateId: 'tpl_tier1_digital_readiness',
...
export const TIER2_DEFAULT_QUESTIONS = [
  {
    templateId: 'tpl_tier2_detailed_assessment',
    sectionId: 'digitalization',
    order: 1,
    kind: 'SINGLE_CHOICE' as const,
...
export const DEFAULT_ASSESSMENT_TEMPLATES = [
  {
    id: 'tpl_01HZXXS3N9', // Keep existing ID for compatibility
  ...
  {
    id: 'tpl_tier2_detailed_assessment',
