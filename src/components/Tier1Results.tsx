        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="flex justify-center gap-4 mb-8 flex-wrap">
            <button
              ...
              className="flex items-center justify-center space-x-2 bg-white border-2 border-gray-200 text-white py-4 px-6 rounded-xl font-semibold hover:border-gray-300 hover:shadow-md transition-all duration-200 w-[240px] whitespace-nowrap"
            ...
            <button
              ...
              className="flex items-center justify-center space-x-2 text-white py-4 px-6 rounded-xl font-semibold hover:opacity-90 hover:shadow-lg transition-all duration-200 w-[240px] whitespace-nowrap"
              style={{ backgroundColor: "#05f" }}
            >
            ...
            <button
              ...
              className="flex items-center justify-center space-x-2 bg-gray-100 text-gray-700 py-4 px-6 rounded-xl font-semibold hover:bg-gray-200 transition-all duration-200 w-[240px] whitespace-nowrap"
            >
